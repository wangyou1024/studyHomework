...
KindEditor.plugin('multiimage', function(K) {
	...
	self.plugin.multiImageDialog = function(options) {
		...
		var swfupload = K.swfupload({
			...
			buttonHeight : 23,
			fileIconUrl : imgPath + 'images.png',
...
// Public: cancelUpload cancels any queued file.  The fileID parameter may be the file ID or html.
...
// step1 to see if the debug setting is true before outputting debug information.
