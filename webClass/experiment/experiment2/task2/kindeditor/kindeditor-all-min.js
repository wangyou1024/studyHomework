...
!function (window, undefined) {
    ...
    function _getInitHtml(a, b, c, d) {
        var e = ["" === _direction ? "<html>" : '<html dir="' + _direction + '">', '<head><meta charset="utf-8" /><title></title>', "<style>", "html {margin:0;padding:0;}", "body {margin:0;padding:5px;}", 'body, td {font:12px/1.5 "sans serif",tahoma,verdana,helvetica;}', "body, p, div {word-wrap: break-word;}", "p {margin:5px 0;}", "table {border-collapse:collapse;}", "img {border:0;}", "noscript {display:none;}", "table.ke-zeroborder td {border:1px dotted #AAA;}", "img.ke-flash {", "	border:1px solid #AAA;", "	background-images:url(" + a + "common/flash.gif);", "	background-position:center center;", "	background-repeat:no-repeat;", "	width:100px;", "	height:100px;", "}", "img.ke-rm {", "	border:1px solid #AAA;", "	background-images:url(" + a + "common/rm.gif);", "	background-position:center center;", "	background-repeat:no-repeat;", "	width:100px;", "	height:100px;", "}", "img.ke-media {", "	border:1px solid #AAA;", "	background-images:url(" + a + "common/media.gif);", "	background-position:center center;", "	background-repeat:no-repeat;", "	width:100px;", "	height:100px;", "}", "img.ke-anchor {", "	border:1px dashed #666;", "	width:16px;", "	height:16px;", "}", ".ke-script, .ke-noscript, .ke-display-none {", "	display:none;", "	font-size:0;", "	width:0;", "	height:0;", "}", ".ke-pagebreak {", "	border:1px dotted #AAA;", "	font-size:0;", "	height:2px;", "}", "</style>"];
    ...
    if (!window.KindEditor) {
        ...
        KEditor.prototype = {
            ...
            }, _each("link,images,flash,media,anchor".split(","), function (a, c) {
                ...
                yesBtn: {
                    name: b.lang("yes"), click: function () {
                        var a = h.map, c = a.getCenter(), d = c.lng + "," + c.lat, g = a.getZoom(),
                            i = [o[0].checked ? b.pluginsPath + "baidumap/html.html" : "http://api.map.baidu.com/staticimage", "?center=" + encodeURIComponent(d), "&zoom=" + encodeURIComponent(g), "&width=" + e, "&height=" + f, "&markers=" + encodeURIComponent(d), "&markerStyles=" + encodeURIComponent("l,A")].join("");
    ...
    b.clickToolbar(c, function () {
        ...
        function h(b, c) {
            ...
            for (var f = (b - 1) * p + o, h = 0; l > h; h++) for (var i = e.insertRow(h), j = 0; m > j; j++) {
                ...
                var n = a('<span class="ke-img"></span>').css("background-position", "-" + 24 * f + "px 0px").css("background-images", "url(" + d + "static.gif)");
    ...
    var b = this, c = "image", d = a.undef(b.allowImageUpload, !0), e = a.undef(b.allowImageRemote, !0),
        ...
        j = b.pluginsPath + "images/images/", k = a.undef(b.extraFileUploadParams, {}),
    ...
    b.plugin.multiImageDialog = function (j) {
        var k = j.clickFn, l = a.tmpl(i.uploadDesc, {uploadLimit: g, sizeLimit: f}),
            ...
            n = b.createDialog({
                ...
                buttonHeight: 23,
                fileIconUrl: e + "images.png",
                uploadDesc: l,
                startButtonValue: i.startUpload,
                uploadUrl: a.addParam(d, "dir=images"),
